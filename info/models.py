...
class Class(models.Model):
    ...
    def __str__(self):
        ...
        return '%s %s' % (d.name, self.section.upper())
...
class StudentCourse(models.Model):
    ...
    def get_cie(self):
        ...
        for mk in marks_list:
            m.append(mk.marks1)
        # Now we have: Internal test 1, Internal test 2, Event 1, Semester End Exam
        # CIE = (Internal test 1 + Internal test 2 + Event 1) / 3
